...
class EntryTest extends TestCase
{
    ...
    public function testDebitAndCreditImplementSameInterface(): void
    {
        ...
        $this->assertInstanceOf(\SoftwareArchetypes\Accounting\Domain\Entry::class, $debit);
        $this->assertInstanceOf(\SoftwareArchetypes\Accounting\Domain\Entry::class, $credit);
    }
}
